...
const DropDown = ({ title, subTitle, items, selectedItem, setSelectedItem, isOpen, setIsOpen }) => {
    ...
    return (
        <label className="flex flex-col gap-4 ">
            ...
            <button className='relative' onClick={(e)=>setIsOpen(!isOpen)} onMouseLeave={(e)=>setIsOpen(false)}>
                ...
                <div className='w-full pl-5 py-2 rounded-[10px] border border-gray-300 focus:border-gray-500 dark:focus:border-slate-500 outline-none transition-all duration-500'>
                    <div
                        ...
                        className={`text-start font-bold ${selectedItem === title ? "font-bold" : ""}`}
                    >
                       {subTitle}
                    </div>
