...
const HeroSection = () => {
  ...
  return (
    <main className='w-full h-full flex flex-col items-center justify-around font--montserra'>
          <div className=' w-full flex items-center  justify-evenly  flex-col md:flex-row'>
            ...
            <div className='flex items-center justify-center  w-full md:w-3xl h-full uppercase font-extrabold  ' style={{ fontSize: "clamp(25px, 4vw, 50px)" }}>
              <h1 className='text-center '>{t("hero.primaryTitle")} <br/><span className='text-[var(--primary)] font-lobster tracking-[10px]'>{t("hero.secondaryTitle")}</span><br/>{t("hero.tertiaryTitle")} </h1>
            </div>
          </div>
