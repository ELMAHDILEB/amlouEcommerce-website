...
const News = () => {
    ...
    return (
        <section className='w-[95%] md:w-full h-[60vh] md:min-h-[80vh] flex flex-col items-center justify-center gap-20  mx-auto my-[10px]  bg-[url("/assets/bg-new.jpg")] bg-center bg-no-repeat bg-cover bg-blend-multiply bg-black/70 text-white text-center rounded-[15px] p-[1%]'>
            ...
            <div className='w-full max-w-[400px] flex items-center'>
                <input type='email' placeholder={t("newsletter.placeholder")} className={`w-full p-3 ${isArabic ? 'rounded-r-[25px]' : 'rounded-l-[25px]'} text-black outline-none bg-gray-200 placeholder:text-black/40 placeholder:italic`} />
