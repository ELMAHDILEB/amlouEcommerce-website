    ...
    return (
        <section className="bg-[rgba(0,0,0,0.5)] text-[var(--blackColor)] w-full h-screen fixed left-0 top-0  z-[1000000000000]">
            <div className="sm:w-full md:w-[50%] h-full bg-[var(--colorBody)] flex flex-col gap-5">
                ...
                <div className="w-full max-h-[68vh] overflow-y-auto space-y-4  flex flex-col">
                    ...
                    <div className="w-full h-fit flex justify-evenly items-center flex-wrap gap-2 bg-[var(--cardColor)] p-2">
                        ...
                        <div className="w-fit  flex flex-col items-center justify-center gap-2">
                            ...
                            <button className="capitalize text-[#ffaea9] underline text-[14px] cursor-pointer">{t("ShoppingCart.removeItem")}</button>
                        </div>
                    </div>
                </div>
                ...
                <button className="capitalize text-[#ffaea9] underline text-[14px] cursor-pointer">{t("ShoppingCart.removeCart")}</button>

                <div className={`absolute bottom-0  w-full md:w-1/2   flex justify-center items-center text-[var(--blackColor)]  text-center ${isArabic ? "right-0" : "left-0"}`}>
                    <span className="w-[50%] py-7 bg-[var(--cardColor)]">{t("ShoppingCart.total")}: 200$</span>
