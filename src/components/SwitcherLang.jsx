...
const SwitcherLang = () => {
  ...
  return (
    <div className="flex flex-col gap-2 relative text-[14px]" onClick={handleOpen}>

      <div className="flex items-center justify-center gap-2 bg-[var(--cardColor)] py-2 px-3 rounded-2xl text-[14px]">
