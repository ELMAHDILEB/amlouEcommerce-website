...
const SwitcherLang = () => {
  ...
  return (
    <div className="flex flex-col gap-2 relative " onClick={handleOpen}>
      ...
      <div className="flex items-center justify-center gap-2 bg-[var(--cardColor)] py-2 px-2 rounded-2xl cursor-pointer">
        ...
        <label  className="text-[12px]">{selectedLang}</label>
...

      {
        open &&
        (
          <div className={`w-full py-3 px-1 bg-[var(--cardColor)]  flex-col items-center absolute top-[55px] rounded-2xl ${open ? "flex" : "hidden"}`}>
